...
export default function RewardSection2() {
  return (
    ...
    >
      ...
      <div className={"mt-10 p-6 lg:p-[46px] bg-bg-grey space-y-6 rounded-3xl"}>
        <div
          className={
        ...
        <div className={"flex justify-center"}>
          <div className={"flex items-center"}>
            <div className={"flex flex-col items-center"}>
              ...
              <p className={"mt-2 text-sm text-center lg:text-2xl font-normal"}>EigenLayer points</p>
            </div>
            ...
            <div className={"flex flex-col items-center"}>
              ...
              <p className={"mt-2 text-sm text-center lg:text-2xl font-normal"}>Zircuit points</p>
            </div>
            <div className={"mx-3 lg:mx-16"}>
              <PlusIcon className={"w-3 h-3 lg:w-8 lg:h-8"} />
            </div>
            <div className={"flex flex-col items-center"}>
              ...
              <p className={"mt-2 text-sm text-center lg:text-2xl font-normal"}>Harmonix points</p>
            </div>
          </div>
        </div>
        <div className={"flex justify-center"}>
