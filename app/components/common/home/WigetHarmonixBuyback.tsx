...
const WidgetHarmonix = ({ className }: WidgetHarmonixProps) => {
  ...
  return (
    <section
      className={cn(
        "relative bg-white border-b border-solid border-gray-300 text-primary",
        className,
      )}
    >
      <motion.div
      ...
      >
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
          <div className="xl:col-span-2 rounded-2xl border border-gray-300 p-3 lg:p-6 shadow-lg">
          ...
          <div className="xl:col-span-1 border shadow-lg border-gray-300 rounded-2xl p-3 lg:p-6 h-full flex flex-col">
