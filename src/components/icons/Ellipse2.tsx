...
const Ellipse2 = ({ className }: IconProps) => {
  return (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 97 97" fill="none">
      <g filter="url(#filter0_f_132_8580)">
        <circle cx="48.5" cy="48.5" r="38.5" fill="url(#paint0_linear_132_8580)" />
      </g>
      ...
      <defs>
        ...
        >
          ...
          <feGaussianBlur stdDeviation="5" result="effect1_foregroundBlur_132_8580" />
        </filter>
        <linearGradient
          id="paint0_linear_132_8580"
          x1="-11.8922"
          y1="40.1961"
          x2="108.892"
          y2="87"
