  ...
  return (
    <div className="pt-28 pb-16">
      <div className="flex flex-col items-center gap-10 w-full md:w-5/6 lg:w-4/5 2xl:w-3/5 mx-auto">
        ...
        <Button color="primary" size="lg" className="rounded-full text-secondary px-6">
          Launch App
        </Button>
      </div>

      <div className="flex justify-center mt-16 pt-[500px]">
        <div className="flex items-center gap-6 bg-primary rounded-full px-4 py-2.5 shadow-md">
          <div className="flex items-center gap-2">
            <UsdtIcon className="w-14 h-14" />
            <UsdcIcon className="w-14 h-14" />
          </div>
          <div>
            <p className="text-sm text-off-white">Harmonix TVL</p>
